...
from durakui.settings import CARD_FONT_NAME, CARD_FONT_SIZE, CARD_SUIT_FONT_NAME, CARD_SUIT_FONT_SIZE, \
    CARD_CENTER_FONT_SIZE, CARD_BACKGROUND_COLOR, CARD_WIDTH, CARD_HEIGHT, CARD_RADIUS, CARD_BORDER_COLOR, \
    CARD_INNER_RECT_WIDTH_SCALE, CARD_INNER_RECT_HEIGHT_SCALE, CARD_INNER_RECT_COLOR, CARD_INNER_RECT_THICKNESS, \
    CARD_TEXT_COLORS, CARD_CORNER_TEXT_MARGIN_LEFT, CARD_CORNER_TEXT_MARGIN_TOP
